package com.lj.service.pay;

import com.lj.common.wxpay.WXPayConfig;
import com.lj.common.wxpay.WXPayConstants;
import com.lj.common.wxpay.WXPayConstants.SignType;
import com.lj.common.wxpay.WXPayRequest;
...
public class WXPayService {
    ...
    public WXPayService(final WXPayConfig config) throws Exception {
        this(config, null, true, false);
    }

    public WXPayService(final WXPayConfig config, final boolean autoReport) throws Exception {
        this(config, null, autoReport, false);
    }


    public WXPayService(final WXPayConfig config, final boolean autoReport, final boolean useSandbox) throws Exception{
        this(config, null, autoReport, useSandbox);
    }

    public WXPayService(final WXPayConfig config, final String notifyUrl) throws Exception {
        this(config, notifyUrl, true, false);
    }

    public WXPayService(final WXPayConfig config, final String notifyUrl, final boolean autoReport) throws Exception {
        this(config, notifyUrl, autoReport, false);
    }

    public WXPayService(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        this.config = config;
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        WXPayUtil.getLogger().info("{}请求参数[{}]",urlSuffix,reqBody);
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        LOGGER.info("WXPayService微信统一下单接口-请求参数[{}]",reqData);
        String respXml = this.requestWithoutCert(url, reqData, connectTimeoutMs, readTimeoutMs);
        LOGGER.info("WXPayService微信统一下单接口-返回参数xml格式的[{}]",respXml);
        return this.processResponseXml(respXml);
    }
